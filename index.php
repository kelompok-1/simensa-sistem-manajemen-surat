...
<script language='JavaScript'>
	var tulisan="SIMENSA - Sistem Manajemen Surat    ";
	var kecepatan=130;var fress=null;function jalan() { document.title=tulisan;tulisan=tulisan.substring(1,tulisan.length)+tulisan.charAt(0);fress=setTimeout("jalan()",kecepatan);}jalan();
</script>
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" id="title">SISTEM MANAJEMEN SURAT</h5>
                            <?php echo '<img id="logo" src="upload/'.$data['logo'].'">';?>
                            <h4 class="center" id="ins">
                            <?php echo ''.$data['nama'].'';?>
                            </h4>
                            <div class="batas"></div>
                        </div>
